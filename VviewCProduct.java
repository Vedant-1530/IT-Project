 ...
 * @author thora
 */
public class VviewCProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           Statement st;
            ...
            out.println("tr:hover { background-color: #e9f5e9; }");
            ...
            out.println("<h2>User Registration Records</h2>");
            out.println("<table>");
            out.println("<tr>");
            ...
            while (rs.next()) {
                ...
                out.println("<td><a class='button' href='Udelete?id=" + sid + "'>Delete</a></td>");
                out.println("</tr>");
            }
