 ...
 * @author thora
 */
public class PostProductServlet1 extends HttpServlet {
       ...
       String filePart = request.getParameter("productImage");
        ...
        String quantity = request.getParameter("quantity"); 
            ...
            Connection co=DriverManager.getConnection("jdbc:mysql://localhost:3306/facebook","root","123456");
             ...
             PreparedStatement ps = co.prepareStatement("INSERT INTO product (product_name,product_description,product_amount, product_image_path, category, phone_no, quantity, user_id) VALUES(?,?,?,?,?,?,?,?)");
//            
            ...
            out.println("<body>");
           if (rowsInserted > 0) {
                RequestDispatcher rd=request.getRequestDispatcher("sellerpage1.jsp");  
