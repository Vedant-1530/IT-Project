 ...
 * @author thora
 */
public class seller_open extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      // Load MySQL JDBC Driver
            ...
            String query = "SELECT * FROM seller_data WHERE Email = ? AND Password = ?";
            ...
            if (rs.next()) {
              ...
              //  System.out.println("sandip:"+userID);
...
//                session.setAttribute("userEmail", email);
        ...
        response.getWriter().println("User logged in. Session data stored!");
                // Redirect to welcome page
                response.sendRedirect("sellerpage1.jsp");
            } else {
                // Invalid login
