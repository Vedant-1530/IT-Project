...
out.println("h1 { text-align: center; margin-top: 20px; color: #c0392b; }");
...
out.println("th { background-color: #e74c3c; color: white; }");
out.println("tr:hover { background-color: #f1f1f1; }");
out.println("img { width: 100px; height: auto; border-radius: 5px; }");
out.println("a.button { padding: 6px 12px; text-decoration: none; color: white; border-radius: 5px; background-color: #e74c3c; }");
out.println("</style>");
out.println("</head>");
out.println("<body>");
out.println("<h1>Delete Product Records</h1>");
out.println("<table>");
out.println("<tr>");
...
while (rs.next()) {
    ...
    out.println("<td><a class='button' href='delete?id=" + id + "'>Delete</a></td>");
    out.println("</tr>");
}
