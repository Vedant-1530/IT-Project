...
<%-- 
    Document   : Seller
    Created on : 20 Feb 2025, 6:33:23 pm
    Author     : thora
--%>
...
<html>
    <head>
        ...
        body {
            ...
            background: url('https://images.unsplash.com/photo-1659407490039-27cc03c0b4b3?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTMxfHxldmVudCUyMGJhY2tncm91bmR8ZW58MHx8MHx8fDA%3D') no-repeat center center fixed;
...
<body>
    ...
    <div class="container">
        <form action="seller_open" method="post">
            <h2>Login</h2>
        ...
        <p class="text-muted"><a href="Forget1.jsp">Forgot password?</a></p>

        <form action="seller_registration.jsp" method="post">
