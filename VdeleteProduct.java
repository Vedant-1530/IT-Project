 ...
 * @author thora
 */
public class VdeleteProduct extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
         ...
         out.println("<!DOCTYPE html>");
            ...
            out.println("a.button { padding: 6px 12px; text-decoration: none; color: white; background-color: #dc3545; border-radius: 4px; font-size: 13px; transition: background-color 0.3s ease; }");
            out.println("a.button:hover { background-color: #c82333; }");
            out.println("</style>");
            out.println("</head>");
            out.println("<body>");

            out.println("<h2>Delete Product Records</h2>");
            out.println("<table>");
            out.println("<tr>");
            ...
            while (rs.next()) {
                ...
                out.println("<td><a class='button' href='Vdelete?id=" + sid + "'>Delete</a></td>");
                out.println("</tr>");
            }
