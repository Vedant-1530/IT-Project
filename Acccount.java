...
public class Acccount extends HttpServlet {
    ...
    PreparedStatement ps = co.prepareStatement("INSERT INTO data (First_name, Surname,Birth_day, Birth_month, Birth_year, Genderf, Genderm, Genderc, Email, Password) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
