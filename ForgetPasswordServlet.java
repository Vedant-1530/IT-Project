...
public class ForgetPasswordServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query = "UPDATE seller_data SET First_name = ?, Password = ? WHERE Email = ?";
    ...
    private String getSuccessPage(String message) {
        return "<html>"
            ...
            + "<a href='Seller.jsp' class='button'>Go Back to Your Profile</a>"
            + "</div>"
            + "</body>"
            + "</html>";
    }
    ...
    private String getErrorPage(String message) {
        return "<html>"
            ...
            + "<div class='message'>" + message + "</div>"
            + "<a href='Seller.jsp' class='button'>Try Again</a>"
            + "</div>"
            + "</body>"
            + "</html>";
    }
