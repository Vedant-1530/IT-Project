<%-- 
    Document   : seller_registration
    Created on : 5 Mar 2025, 8:06:38 pm
    Author     : thora
--%>
...
.box7
    ...
    right: 0;
    border-radius: 20px;
    background-color: #232f3e; /* //#dddddd*/
    border-style: solid;
    border-color: white;
    }
    ...
    <body>
        ...
        <div class="box3">
                <form  action="seller_account" method="post"  >  
...
<p class="box6" > Gender ? </p>
            ...
            <p align="center"> <a href="Seller.jsp">Already have an account?</a>  </p>   
        </div>
        </div>
    </body>
</html>
